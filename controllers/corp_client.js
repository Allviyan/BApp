const User = require('../models/corp_client');
...
exports.registerCorporate = (req, res) => {
    // console.log(req.body);
    User.findOne({ username: req.body.username }).exec((err, user) => {
        if (user) {
            return res.status(400).json({
...
exports.updateCorporateStatus = (req, res) => {
    const slug = req.params.slug.toLowerCase();
...
exports.deactivateCorporateStatus = (req, res) => {
    const slug = req.params.slug.toLowerCase();
    var myquery ={ _id: slug }
    var newV = {approved: 0}
    User.updateOne(myquery,newV).exec((err, data) => {
...
exports.updateCorporateDetails = (req, res) => {
    const slug = req.params.slug.toLowerCase();
    var myquery ={ _id: slug }
